        ...
        <div className="container">
            {news?.name ? (
                <div className="mt-3 border rounded p-3 shadow bg-light">
                    ...
                    <p><span className="fw-bold fs-5">Thời gian: </span>{news?.date}</p>
                    <p><span className="fw-bold fs-5">Địa điểm: </span>{news?.location}</p>
                    <p><span className="fw-bold fs-5">Số lượng sinh viên tối đa: </span>{news?.numPeople}</p>
                    <p><span className="fw-bold fs-5">Tiêu chí xét SV5T: </span>{news?.target}</p>
                    <p>
                        <span className="fw-bold fs-5">Thông tin chi tiết: </span><br />
                        {news.summary}
                    </p>
                    <hr />
                    <button
